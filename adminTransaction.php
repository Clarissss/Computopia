...
session_start();
$query_transaksi = "SELECT payments.transaction_id, product.product_name, users.user_name, order_items.product_quantity, product.product_price, order_items.order_date
          FROM order_items
          JOIN product ON order_items.product_id = product.product_id
          JOIN users ON order_items.user_id = users.user_id JOIN payments on users.user_id = payments.user_id";
if (!$result_transaksi = mysqli_query($conn, $query_transaksi)) {
