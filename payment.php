...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['complete_payment'])) {
    ...
    if ($stmt->execute()) {
        ...
        $stmt_payment->bind_param('iiss', $order_id, $transaction_id, $user_id, $payment_date); // Bind user_id parameter
...
<body>
    ...
    return actions.order.capture().then(function(orderData) {
        ...
        const transactionId = transaction.id; // Ambil transaction_id dari PayPal
        document.getElementById('transaction-id').value = transactionId; // Setel nilai transaction_id ke input
