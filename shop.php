  ...
  <div class="row">
    ...
    <div class="product-card">
      <div class="product-icons">
        <a href="#" @click.prevent="$store.cart.add(<?php echo $row['product_id']; ?>)">
          <svg
            width="24"
            height="24"
            fill="none"
      ...
      <button type="submit" class="btn" name="product_id" value="<?php echo $row['product_id'];?>">Add to Cart</button>
      </div>
    </div>
    <?php } ?>
  </div>
